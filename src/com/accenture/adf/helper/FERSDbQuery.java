...
public class FERSDbQuery {
	...
	public String getsearchbyuname() {
		return searchbyuname;
	}

	public void setsearchbyuname(String searchbyuname) {
		this.searchbyuname = searchbyuname;
	}
