...
<body onload="displayStatus()">
	...
	<form method="post" name="changePWD" action="changePWD.htm"
					...
					<table align="center" border="0">
							...
							<td>
								...
								<table align="center" border="0">
									...
									<tbody>
										...
										<tr>
											<td><span
												style="font-weight: bold; color: red; font-size: 15px;">*</span>New
												Password:</td>
						...
						<tr>
							<td colspan="2" align="center"><span
								style="font-weight: bold; color: red; font-size: 15px;">${errorMsg}</span></td>
						</tr>
					</table>
				</td>
			</tr>
